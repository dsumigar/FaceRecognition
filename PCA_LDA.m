...
facesFolder_train = 'C:\Users\zhang\OneDrive\Desktop\EC520 Digital Image Processing\FaceID\ResizedTrain\';            % Location of training set of face images
outputFolder_train = 'C:\Users\zhang\OneDrive\Desktop\EC520 Digital Image Processing\FaceID\PreprocecessedTrain\';    % Initialize folder to hold pre-processed training set of face images
...
facesFolder_test = 'C:\Users\zhang\OneDrive\Desktop\EC520 Digital Image Processing\FaceID\ResizedTest\';
outputFolder_test = 'C:\Users\zhang\OneDrive\Desktop\EC520 Digital Image Processing\FaceID\PreprocessedTest\';
...
%% Reconstruction of the Face Images Projected onto LDA Subspace

reconstructed_LDA = u * reduced_dim_top_c_minus_1_eigenvectors' * LDA_basis_reduced';

ooooo = zeros(length(lTrain), n);
% Training Images
for i = 1:length(lTrain)
    for j = 1:length(Subjects)
        if (lTrain(i) == j)
            ooooo(i, :) = reconstructed_LDA(i,:) + avgFace_Classes(j,:);
        end
    end
end
